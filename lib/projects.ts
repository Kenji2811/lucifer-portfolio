export const projects = [
  ...
  },
  {
    number: "03",
    slug: "pandemonium",
    title: "Spatial Identity & CGI",
    codename: "Pandemonium",
    category: "Spatial",
    discipline: "Environmental graphics / 3D visualization",
    year: "2026",
    mark: "P",
    background: "#d6d0c7",
    foreground: "#16130f",
    introduction:
      "A self-initiated spatial identity study combining environmental graphics, wayfinding and atmospheric CGI.",
    overview:
      "The project translates a graphic system into an imagined built environment. Monumental typography, pale mineral surfaces and dark thresholds are developed across environmental graphics, navigation cues and a suite of 3D visualization frames.",
    role: "Spatial art direction / CGI visualization",
    scope: ["Environmental graphics", "Wayfinding system", "3D visualization"],
    duration: "Concept study / 10 weeks",
    keywords: ["Wayfinding", "Material", "Atmosphere"],
  },
] as const;
