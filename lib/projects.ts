export const projects = [
  {
    ...
    foreground: "#1b0c06",
    introduction:
      "A ceremonial identity built around light, ascent and a precise visual language.",
    overview:
      "Morningstar explores the tension between the sacred and the contemporary. The system moves from a singular monogram into packaging, print and digital applications without losing its sharp, restrained character.",
    role: "Creative direction / Design",
    scope: ["Identity system", "Packaging", "Digital direction"],
    duration: "08 weeks",
    keywords: ["Light", "Ascent", "Ritual"],
  },
  {
    number: "02",
    slug: "inferno",
